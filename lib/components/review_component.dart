...
import 'package:prokit_flutter/screen/user_profile_screen.dart';
          ...
          children: [
            nextpart.isNotEmpty
                ? Text(
                    ...
                    style: secondaryTextStyle(fontSize: 14, color: Colors.white70),
                  )
                : Text(
                    firstpart,
                    textAlign: TextAlign.justify,
                    style: secondaryTextStyle(color: Colors.white70, fontSize: 14),
                  ),
            GestureDetector(
              onTap: () {
                readMore = !readMore;
              ...
              child: Text(
                ...
                style: boldTextStyle(color: Colors.red, fontSize: 12),
              ),
            )
          ],
        ),
        Row(
          ...
          children: [
            ...
            Text(
              ...
              style: secondaryTextStyle(fontSize: 12, color: Colors.white60),
            ),
          ],
        ),
      ],
