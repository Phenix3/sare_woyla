...
import 'package:prokit_flutter/screen/subscription_screens/payment_status_screen.dart';
                        ...
                        child: Row(
                          ...
                          children: [
                            Text('${component[index][i]}',
                                style: index != 2 ? secondaryTextStyle() : boldTextStyle(fontSize: 14)),
                            index == 0 && i == 0
                                ? GestureDetector(
                                    onTap: () {},
                                    // style: ButtonStyle(
                                    //   backgroundColor: durationOfPremium == '1 Year'
                                    ...
                                    child: Container(
                                      ...
                                      child: Wrap(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '${orderValue[index][i]}',
                                            style: boldTextStyle(fontSize: 14, color: Colors.black),
                                          ),
                                        ],
                                      ),
                                    ),
