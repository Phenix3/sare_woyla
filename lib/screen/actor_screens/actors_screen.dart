...
import 'package:prokit_flutter/screen/actor_screens/actor_detail_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Actors ', textAlign: TextAlign.center, style: boldTextStyle(fontSize: 24)),
        centerTitle: true,
      ),
