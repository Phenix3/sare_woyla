...
import 'package:prokit_flutter/model/profile_model.dart';
import 'package:prokit_flutter/screen/authentication_screen/change_password_screen.dart';
import 'package:prokit_flutter/screen/authentication_screen/logout_screen.dart';
import 'package:prokit_flutter/screen/history_screen.dart';
import 'package:prokit_flutter/screen/setting_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Profile', style: boldTextStyle(fontSize: 24)),
        centerTitle: true,
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Your Activities', style: boldTextStyle(fontSize: 22)),
                SizedBox(height: 16),
                Wrap(
                  runSpacing: 16,
                ...
                SizedBox(height: 32),
                Text('Account', style: boldTextStyle(fontSize: 22)),
                SizedBox(height: 16),
                Wrap(
                  runSpacing: 16,
                  children: List.generate(
